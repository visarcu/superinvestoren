...
async function run() {
  ...
  for (const [slug, cik] of Object.entries(investorCiks)) {
    ...
    if (slug !== 'donaldsmith' && slug !== 'karr' && slug !== '') continue
