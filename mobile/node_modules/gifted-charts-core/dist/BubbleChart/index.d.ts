import { BarAndLineChartsWrapperTypes, RegressionLineConfig, RegressionLineCoordinates } from '../utils/types';
...
export declare const useBubbleChart: (props: extendedBubbleChartPropsType) => {
    ...
    centerColorForGradient: import("react-native").ColorValue;
};
