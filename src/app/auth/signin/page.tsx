// src/app/auth/signin/page.tsx - QUARTR STYLE DESIGN
'use client'
  ...
  return (
    <>
      ...
      >
        ...
        <span className="text-sm font-medium text-neutral-300">Mit Google anmelden</span>
      </button>
      ...
      <form onSubmit={handleSignIn} className="space-y-4">
        ...
        {/* Sign In Button - Light/White Style */}
        <button
          type="submit"
          disabled={loading}
