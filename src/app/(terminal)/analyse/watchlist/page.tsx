// src/app/watchlist/page.tsx - MIT THEME SUPPORT
'use client';
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg transition font-medium ${
                    showOnlyDips 
                      ...
                      : 'bg-theme-secondary text-theme-secondary hover:bg-theme-tertiary hover:text-theme-primary border border-theme'
                  }`}
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-green-500 text-black rounded-lg hover:bg-green-400 disabled:bg-theme-tertiary disabled:text-theme-muted disabled:cursor-not-allowed transition font-medium"
                >
        ...
        {filteredItems.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredItems.map((item) => {
              ...
              return (
                <div key={item.id} className="bg-theme-card/70 border border-theme rounded-xl p-6 backdrop-blur-sm hover:bg-theme-card/80 hover:border-border-hover transition-all duration-200">
                  
                  {/* Header mit Logo und Dip-Indikator */}
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 bg-theme-secondary/50 rounded-xl flex items-center justify-center">
                        <Logo
                  ...
                  <div className="mt-6">
                    <Link
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-theme-secondary text-theme-secondary rounded-lg hover:bg-theme-tertiary hover:text-theme-primary transition font-medium border border-theme"
                    >
