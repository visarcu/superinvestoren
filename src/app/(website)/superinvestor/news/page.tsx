...
export default function SuperinvestorNewsPage() {
  return (
    <div className="min-h-screen bg-theme-primary">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-theme-card to-theme-primary py-20 border-b border-theme/10">
      ...
      {/* Features Section */}
      <section className="py-16 bg-theme-card/30 border-t border-theme/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-theme-primary mb-2">Portfolio Tracking</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-theme-primary mb-2">Trending Stocks</h3>
              <p className="text-theme-muted text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-theme-primary mb-2">Major Moves</h3>
              <p className="text-theme-muted text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-theme-primary mb-2">Relevance Scoring</h3>
              <p className="text-theme-muted text-sm">
