      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand/10 text-white-400 rounded-full text-sm font-medium mb-6" style={{ borderColor: 'var(--border-color)' }}>
...
<section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand/10 text-brand-light rounded-full text-sm font-medium mb-6" style={{ borderColor: 'var(--border-color)' }}>
