...
const investorNames: Record<string, string> = {
  ...
  viking: 'Ole Andreas Halvorsen - Viking Global',
  ...
  baron_partners_fund: 'Ron Baron - Baron Partners Fund',
  ark_innovation_etf: 'Catherine Wood - ARK Innovation ETF',
  'samantha-mclemore': 'Samantha McLemore - Patient Capital Management',
  'tom-bancroft': 'Tom Bancroft - Makaira Partners',
