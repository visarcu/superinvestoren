// src/app/analyse/[ticker]/news/page.tsx - Ticker-spezifische News-Seite
'use client'
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              <LoadingSpinner />
              <p className="text-gray-400 mt-4">Lade Nachrichten für {ticker}...</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-lg">Aktuelle News und Marktentwicklungen</p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          {filteredNews.slice(0, user?.isPremium ? undefined : 5).map((article, index) => (
            <article 
              ...
              className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-700 hover:border-gray-600 transition-all duration-300 overflow-hidden group"
            >
              <div className="p-6">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      {user?.isPremium && (
                        ...
                        >
                          <BookmarkSolidIcon 
                            className={`w-5 h-5 ${
                              savedArticles.has(article.url) ? 'text-yellow-400' : 'text-gray-400'
                            }`} 
                          />
                        </button>
                      )}
        ...
        {!user?.isPremium && (
          <div className="bg-gradient-to-r from-green-500/10 via-blue-500/10 to-purple-500/10 border border-gray-700 rounded-2xl p-8 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Unlimited News Access</h3>
