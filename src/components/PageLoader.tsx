  ...
  return (
    <div className="min-h-screen bg-theme-primary">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-6 h-6 bg-brand/20 rounded animate-pulse"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {[0,1,2,3].map(i => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-gradient-to-br from-brand/10 to-green-500/5 rounded-xl animate-pulse"></div>
        ...
        {/* Dropdown Skeleton */}
        <div className="bg-gradient-to-r from-green-500/5 to-transparent border border-brand/20 rounded-xl p-4 mb-8 animate-pulse">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-brand/10 rounded-lg"></div>
              <div>
          ...
          {[0,1,2].map(i => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-gradient-to-br from-brand/10 to-green-500/5 rounded-xl"></div>
                <div className="flex-1">
              ...
              <div className="space-y-3">
                {[0,1,2,3,4].map(j => (
                  ...
                  >
                    ...
                    <div className="h-6 w-12 bg-brand/10 rounded"></div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none">
          <div className="flex items-center gap-3">
            <ChartBarIcon className="w-8 h-8 text-brand/30 animate-pulse" />
