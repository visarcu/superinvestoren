  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Piotroski F-Score - Terminal Style */}
          ...
          <div className="bg-theme-card border border-theme/10 rounded-lg p-6 hover:bg-theme-tertiary/10 transition-all duration-200">
              ...
              <div className="space-y-1">
                <div className={`text-base font-semibold ${
                  ...
                  {piotroskiScore >= 8 ? 'Sehr stark' :
                   piotroskiScore >= 6 ? 'Stark' :
                   piotroskiScore >= 4 ? 'Durchschnitt' : 'Schwach'}
                </div>
                <div className="text-sm text-theme-muted">
                  {piotroskiScore >= 8 ? 'Exzellente Fundamentaldaten' :
                   piotroskiScore >= 6 ? 'Gute Fundamentaldaten' :
                   piotroskiScore >= 4 ? 'Gemischte Fundamentaldaten' : 'Schwache Fundamentaldaten'}
                </div>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="bg-theme-tertiary/50 rounded h-2">
                <div 
                  className={`h-2 rounded transition-all duration-1000 ${
                    piotroskiScore >= 6 ? 'bg-green-400' : 
                    piotroskiScore >= 4 ? 'bg-yellow-400' : 'bg-red-400'
                  }`}
                  style={{ width: `${(piotroskiScore / 9) * 100}%` }}
                />
              </div>
            </div>
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className="flex justify-between py-1">
                ...
                <span className="text-yellow-400 font-medium">Durchschnitt</span>
              </div>
              <div className="flex justify-between py-1">
                <span className="text-theme-muted font-mono">&lt; 4</span>
                <span className="text-red-400 font-medium">Schwach</span>
              </div>
            </div>
          </div>
        )}
