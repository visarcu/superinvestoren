...
const PremiumBlur = ({ children, isPremium, title }: { children: React.ReactNode, isPremium: boolean, title: string }) => {
...
const PremiumTabLock = ({ title, description }: { title: string, description: string }) => {
  return (
    <div className="flex flex-col items-center justify-center py-16">
      <div className="bg-theme-card/50 backdrop-blur-sm rounded-xl p-8 text-center max-w-md">
        <LockClosedIcon className="w-12 h-12 text-theme-muted mx-auto mb-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-theme-card border border-theme/10 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  {isPremium ? (
                    ...
                    <div className="relative">
                      <p className="text-2xl font-bold text-theme-primary filter blur-sm select-none">{data.summary.formattedTotalValue}</p>
                      <div className="absolute inset-0 flex items-center">
                        <span className="flex items-center gap-1 text-xs text-theme-muted bg-theme-card/80 px-2 py-1 rounded">
              ...
              {isPremium ? (
                ...
                <p className="text-xs text-theme-muted filter blur-sm select-none">
                  Ø {data.summary.formattedAveragePosition} pro Investor
                </p>
              )}
            </div>
            ...
            <div className="flex space-x-8">
              ...
              >
                <span className="flex items-center gap-2">
                  ...
                  Quarterly Activity
                  {!isPremium && <LockClosedIcon className="w-3 h-3 text-theme-muted" />}
                </span>
              </button>
              <button
