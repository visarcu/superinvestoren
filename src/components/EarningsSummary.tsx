    ...
    if (loading) {
      return (
        <div className="space-y-3">
          <div className="h-4 bg-theme-tertiary/50 rounded animate-pulse"></div>
          <div className="h-4 bg-theme-tertiary/50 rounded animate-pulse w-3/4"></div>
          <div className="h-4 bg-theme-tertiary/50 rounded animate-pulse w-5/6"></div>
        </div>
      )
    }
