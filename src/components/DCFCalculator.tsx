        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-brand/10 border border-brand/20 rounded-lg text-brand-light hover:bg-brand/20 transition-colors disabled:opacity-50"
            >
          ...
          {dcfResult && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-gray-900/50 rounded-lg p-4">
                ...
                <div className={`text-2xl font-bold ${upside > 0 ? 'text-brand-light' : 'text-red-400'}`}>
